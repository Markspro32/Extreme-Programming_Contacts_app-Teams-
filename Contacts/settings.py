...
SECRET_KEY = 'django-insecure-*jt6(hmd$fsb&vhw*nthxt8^tl8=f+tp-d&&&eazi8koi%3r+h'
...
INSTALLED_APPS = [
    ...
    # my app
    'contacts_app',
    # corsheaders can help us to handle the CORS issue.
    'corsheaders'
]
...
# For schoolwork only — allows frontend from any origin
